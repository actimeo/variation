...
'</table>');
	    ...
	    $.getJSON ("/ajax/etablissement_secteur_liste.php", { prm_eta_id: o.eta_id, prm_est_prise_en_charge: 1, output: 'json2' }, function (data) {
		if (data) {
		...
		$.getJSON ("/ajax/etablissement_secteur_liste.php", { prm_eta_id: o.eta_id, prm_est_prise_en_charge: 0, output: 'json2' }, function (data2) {
		    if (data2) {
